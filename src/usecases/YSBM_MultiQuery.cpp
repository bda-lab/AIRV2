...
#include "../yahoo_m_multiquery/WinJoinSlice_m.hpp"
#include "../yahoo_m_multiquery/QueryAggregator_m.hpp"
#include "../yahoo_m_multiquery/QueryCollector_m.hpp"


using namespace std;

YSBM_MultiQuery::YSBM_MultiQuery(unsigned long throughput, int queries) :
		Dataflow() {
	...
	ratioFinder = new WinJoinSliceM(9, rank, worldSize, queries);
	queryAggregator = new QueryAggregatorM(10, rank, worldSize, queries);
